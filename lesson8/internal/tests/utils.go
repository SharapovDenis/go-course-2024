...
func getTestClient() *testClient {
	server := httpgin.NewHTTPServer(":18080", app.New())
...
func (tc *testClient) createUser(name, email string) (userResponseWrapper, error) {
	body := map[string]any{
		"name":  name,
		"email": email,
	}
	...
	data, err := json.Marshal(body)
	if err != nil {
		return userResponseWrapper{}, err
	}
...
func (tc *testClient) updateUser(userID int64, name, email string) (userResponseWrapper, error) {
	body := map[string]any{
		"name":  name,
		"email": email,
	}
